...
io.on('connection', (client) => {
    ...
    client.on('entrarChat', (data, callback)=>{
        ...
        if (!data.nombre || !data.sala) {
            return callback({
                error:true,
                mensaje:'El nombre/sala es necesaario es necesario'
            })
        }
    ...
    client.on('disconnect', ()=>{
        ...
        client.broadcast.to(personaBorrada.sala).emit('crearMensaje', crearMensaje('Administador', `${personaBorrada.nombre} abandono el chat`))
